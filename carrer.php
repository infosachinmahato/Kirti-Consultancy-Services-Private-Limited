    ...
    <div class="contact-full-width">
        ...
        <div class="contact-fix-width">
            <div class="contact-content" style="margin-top: 40px;">
                <form action="careerdb.php" method="POST">
                    <div class=" mb-3">
                    ...
                    <br>
                    <div class="mb-3">
                        <label class="form-label" style="position: relative; bottom: 10px;">Skill</label>
                        <input type="text" id="skill" class="form-control"" placeholder="Web Development \ App Development \ Software Development" required name="skill">
                    </div>
                    <br>
