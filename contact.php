...
<body>
    ...
    <div class="container" style="max-width: 85%; margin-top: 40px;" id="alertFrom">
        <div class="alert alert-success" role="alert" style="background-color: #ffffff;">
            <div class="alert alert-primary" role="alert" style="font-size: 13px;">
                Mobile No <a  class="alert-link">    8860911915</a>.   Call Now.
              </div>
              <div class="alert alert-secondary" role="alert" style="font-size: 13px;">
                H.R No <a href="#" class="alert-link"> 8447800199</a>. Call Now.
              </div>
              <div class="alert alert-success" role="alert" style="font-size: 13px;">
                Helpline No <a href="#" class="alert-link"> 9911172593</a>. Call Now.
              </div>
              <div class="alert alert-danger" role="alert" style="font-size: 13px;">
                24hours Help Email <a href="#" class="alert-link"> sharedigitalworld@gmail.com</a>. Send Email.
              </div>
        </div>
    </div>
    ...
    <main>
        ...
        <div class="contact-full-width">
            <h1
                style="padding: 20px; color: #024397; text-align: center; font-size: 17px; font-weight: 700; text-transform: uppercase; margin-top: 20px;">
            ...
            <div class="contact-fix-width">
                <div class="contact-content" style="margin-top: 40px;">
                    <form action="contactdb.php" method="POST">
                        <div class=" mb-3">
                            <label class="form-label" style="position: relative; bottom: 10px;">Full Name</label>
                            <input type="text" id="fName" class="form-control"" placeholder=" Enter Your Full Name" required name="full_name">
                        </div>               
                        <br>
                        <div class="mb-3">
                            <label class="form-label" style="position: relative; bottom: 10px;">Mobile Number</label>
                            <input type="number" id="mobileNo" class="form-control" placeholder=" Enter Your Mobile Number" required name="mobile_number">
                        </div>
                        <br>
                        <div class="mb-3">
                            <label class="form-label" style="position: relative; bottom: 10px;">Email Id</label>
                            <input type="email" id="emailId" class="form-control"" placeholder=" Enter Your Email Id" required name="email_id">
                        </div>
                        <br>
                        <div class="mb-3">
                            <textarea name="users_sms" id="" cols="30" rows="10"></textarea>
                        </div>
                        <br>
                        <input type="submit" class="btn btn-primary" style="background:#fa0002; border: none;">
                    </form>
            </div>
        </div>
        </div>
