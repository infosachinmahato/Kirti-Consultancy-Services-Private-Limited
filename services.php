...
<body>
    ...
    <main>
        <div class="services_full_width">
            <h1
                style="padding: 20px; color: #024397; text-align: center; font-size: 17px; font-weight: 700; text-transform: uppercase;">
                <i class="fi fi-rs-settings-sliders" style="color: #fa0002; position: relative; top: 1.5px; left: 0px; 
            margin-right: 9px;"></i>OUR SERVICES
            </h1>
            <div class="services_fix_width">
                <div class="services_content">
                    <div class="ser_web_bd ser_margin">
                        <img src="IMAGES/SLIDER BANNER/service_web_development.png" alt="Web devlpop"
                            style="width: 100%;">
                        <h1
                            style="padding: 20px; font-size: 15px; font-weight: 200; color: rgb(116, 116, 116); letter-spacing: 1px;">
                            Web Development Best Services</h1>
                    </div>
                    <div class="ser_web_bd ser_margin">
                        ...
                        <h1
                            style="padding: 20px; font-size: 15px; font-weight: 200; color: rgb(116, 116, 116); letter-spacing: 1px;">
                            App Development Best Services</h1>
                    </div>
                    <div class="ser_web_bd">
                        ...
                        <h1
                            style="padding: 20px; font-size: 15px; font-weight: 200; color: rgb(116, 116, 116); letter-spacing: 1px;">
                            Software Development Best Services</h1>
                    </div>
                </div>
                <div class="services_content" style="margin-top: -11px;">
                    <div class="ser_web_bd ser_margin">
                        ...
                        <h1
                            style="padding: 20px; font-size: 15px; font-weight: 200; color: rgb(116, 116, 116); letter-spacing: 1px;">
                            Digital Marketing Best Services</h1>
                    </div>
                    <div class="ser_web_bd ser_margin">
